<?php
	...
	'<table cellpadding="1">
		<tr bgcolor="#808080" style="color:#FFFFFF">		
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="6%"><b>Núm. Colaborador</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="15%"><b>Colaborador</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="5%"><b>Núm. Centro</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="15%"><b>Centro</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="5%"><b>Núm. Puesto</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="15%"><b>Puesto</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="8%"><b>Fecha Ingreso</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="5%"><b>Núm. Usuario</b></td>
	...
	try{
		...
		foreach($matriz as $fila){
			...
			$dFechaIngreso = date("d/m/Y", strtotime($fila['dfechaingreso']));
			...
			'<tr>
				...
				<td align="center" style="border: 1px solid #000000;" width="8%">'.$dFechaIngreso.'</td>
...
// set default header data
	$pdf->SetHeaderData('', '',  '', "REPORTE DE COLABORADORES CON PRESTACIÓN SIN ANTIGÜEDAD\nImpreso el: $hoy");
...
EOD;
	...
	// This method has several options, check the source code documentation for more information.
ob_end_clean ();
$pdf->Output('Reporte Empleados Prestacion sin Antiguedad.pdf', 'D');
?>