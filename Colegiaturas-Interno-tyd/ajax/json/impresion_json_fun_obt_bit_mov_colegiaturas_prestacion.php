	...
	$imprimir = 
		'<table cellpadding="1">
			<tr bgcolor="#808080" style="color:#FFFFFF">
				...
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="15%"><b>Escolaridad</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="10%"><b>Porcentaje</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="20%"><b>Región</b></td>
			</tr>
			<tr bgcolor="#808080" style="color:#FFFFFF">
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="20%"><b>Ciudad</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="10%"><b>Fecha Ingreso</b></td>
				...
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="10%"><b>Fecha Registro</b></td>
			</tr>';
		...
		foreach($matriz as $fila){
			...
			$imprimir.=
				'<tr>
					...
					<td align="lefth" style="border: 1px solid #000000;" width="15%">'.$sPuestoCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="15%">'.$sEscolaridad.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="10%">'.$iPorcentaje.'%</td>
					<td align="lefth" style="border: 1px solid #000000;" width="20%">'.$sRegionCol.'</td>
					
				</tr>                                                           
				<tr>
					<td align="lefth" 	style="border: 1px solid #000000;" width="20%">'.$sCiudadCol.'</td>
					<td align="center" 	style="border: 1px solid #000000;" width="10%">'.$fechaIngreso.'</td>
					...
					<td align="lefth" 	style="border: 1px solid #000000;" width="20%">'.$sCentroUsu.'</td>
					<td align="center" 	style="border: 1px solid #000000;" width="10%">'.$fechaRegistro.'</td>
				</tr>
				<br>';
		}
		$imprimir.='</table>';
...
// set default header data
	$pdf->SetHeaderData('', '',  '', "".encodeToUtf8("REPORTE BITÁCORA PRESTACIÓN SIN ANTIGUEDAD")."\nImpreso el: $hoy");
...
EOD;
	...
	// This method has several options, check the source code documentation for more information.
ob_end_clean ();
$pdf->Output('REPORTE BITACORA PRESTACION SIN ANTIGUEDAD.pdf', 'D');
?>