<?php
	...
	$imprimir = 
		'<table cellpadding="1">
			<tr bgcolor="#808080" style="color:#FFFFFF">
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Fecha</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="27%"><b>Folio Factura</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Importe Original</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Importe Nuevo</b></td>
			</tr>
			<tr bgcolor="#808080" style="color:#FFFFFF">
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Colaborador</b></td>
			<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="27%"><b>Puesto</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Escolaridad</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="24%"><b>Porcentaje</b></td>
			</tr>
			<tr bgcolor="#808080" style="color:#FFFFFF">
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="33%"><b>Centro</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="33%"><b>Ciudad</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="33%"><b>Región</b></td>
			</tr>
			<tr bgcolor="#808080" style="color:#FFFFFF">
	...
	try{
		...
		foreach($matriz as $fila){
			...
			$folio = trim(encodeToUtf8($fila['folio_factura']));
			$importe_o = number_format($fila['importe_original'],2);
			$importe_p = number_format($fila['importe_pagado'],2);
			...
			$iPorcentaje = trim(encodeToUtf8($fila['porcentaje']));
			$sEscolaridad = trim(encodeToUtf8($fila['escolaridad']));
			
			$imprimir.=
				'<tr>
					<td align="lefth" style="border: 1px solid #000000;" width="24%">'.$fechaRegistro.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="27%">'.$folio.'</td>
					<td align="right" style="border: 1px solid #000000;" width="24%">'.$importe_o.'</td>
					<td align="right" style="border: 1px solid #000000;" width="24%">'.$importe_p.'</td>
				</tr>
				<tr>
					<td align="lefth" style="border: 1px solid #000000;" width="24%">'.$sColaborador.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="27%">'.$sPuestoCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="24%">'.$sEscolaridad.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="24%">'.$iPorcentaje.'%</td>
				</tr>
				<tr>
					<td align="lefth" style="border: 1px solid #000000;" width="33%">'.$sCentroCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="33%">'.$sCiudadCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="33%">'.$sRegionCol.'</td>
				</tr>
				<tr>
...
// set default header data
	$pdf->SetHeaderData('', '',  '', "REPORTE ".encodeToUtf8("BITÁCORA")." EDITAR IMPORTE A PAGAR\nImpreso el: $hoy");
...
EOD;
	...
	// This method has several options, check the source code documentation for more information.
ob_end_clean ();
$pdf->Output('REPORTE BITACORA EDITAR IMP A PAGAR.pdf', 'D');
?>