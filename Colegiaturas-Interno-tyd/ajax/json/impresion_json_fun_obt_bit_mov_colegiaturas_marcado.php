<?php
	...
	$iTipoMovimientoBitacora = isset($_GET['iTipoMovimientoBitacora']) ? $_GET['iTipoMovimientoBitacora'] : 1;
	...
	$imprimir = 
		'<table cellpadding="1">
			...
			<tr bgcolor="#808080" style="color:#FFFFFF">
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="30%"><b>Centro</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="30%"><b>Ciudad</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="20%"><b>Región</b></td>
				<td align="center" style="border: 1px solid #000000;vertical-align:middle;" width="19%"><b>Estatus</b></td>
			</tr>
			<tr bgcolor="#808080" style="color:#FFFFFF">
	...
	try{
		...
		foreach($matriz as $fila){
			...
			$imprimir.=
				...
				<tr>
					<td align="lefth" style="border: 1px solid #000000;" width="30%">'.$sCentroCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="30%">'.$sCiudadCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="20%">'.$sRegionCol.'</td>
					<td align="lefth" style="border: 1px solid #000000;" width="19%">'.$sEstatus.'</td>
				</tr>
				<tr>
...
if($iTipoMovimientoBitacora == 4){
	$pdf->SetHeaderData('', '',  '', "REPORTE ".encodeToUtf8("BITÁCORA")." COLABORADOR MARCADO ESPECIAL.\nImpreso el: $hoy");	
}ELSE{
	$pdf->SetHeaderData('', '',  '', "REPORTE ".encodeToUtf8("BITÁCORA")." COLABORADOR DESMARCADO ESPECIAL.\nImpreso el: $hoy");	
}
...
ob_end_clean ();
if($iTipoMovimientoBitacora == 4){
	$pdf->Output('REPORTE BITACORA COLABORADOR MARCADO ESPECIAL.pdf', 'D');
}ELSE{
	$pdf->Output('REPORTE BITACORA COLABORADOR DESMARCADO ESPECIAL.pdf', 'D');
}
?>