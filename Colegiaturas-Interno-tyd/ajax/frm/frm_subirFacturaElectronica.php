...
<div class="page-content">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid" id="sh-info-colab" style="margin-bottom:10px; Cursor: pointer;">
			<h4>Datos del Colaborador <b id="arrow-info-colab" class="arrow icon-angle-right"></b></h4>
		</div>
		
		<div class="control-group" id="info-colab">
			<div class="row-fluid">
				<div class="span4">
				...
				<div class="row-fluid">
					<div class="span9">
						...
						<div class="controls" id="div_xml">
							...
							<input type="hidden" id="txt_Num_Gte" name="txt_Num_Gte" />
							<input type="hidden" id="txt_Nom_Gte" name="txt_Nom_Gte" />
