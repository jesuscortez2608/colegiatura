...
<script type="text/javascript" src="files/js/frm_reporteBecasPuesto.js"></script>
...
<div class="page-content">
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<br>
				<div id="gridReportePuesto">
					<table id="gridReportePuesto-table"></table>
					<div id="gridReportePuesto-pager"></div>
				</div>
			</div>
		</div>
	</div>
