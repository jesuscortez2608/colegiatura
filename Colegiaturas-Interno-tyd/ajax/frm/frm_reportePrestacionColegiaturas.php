...
<script type="text/javascript" src="files/js/frm_reportePrestacionColegiaturas.js"></script>
...
<div class="span12 form-horizontal">
	<div class="span12">
		<div class="span8">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="txt_numEmp" class="span4 numbersOnly" maxlength="8" tabindex="1" />
		...
		<div class="span11" align="right">
			<div class="controls">
				<button class="btn btn-small btn-primary" id="btn_Consultar" tabindex="4">
	...
	<div class="span11">
		<div class="control-group">
			<div id="gridPrestacion">
				<table id="gridPrestacion-table"></table>
				<div id="gridPrestacion-pager"></div>
			</div>
		</div>
	</div>
</div>