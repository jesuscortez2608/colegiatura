...
<script type="text/javascript" src="files/js/frm_configuracionClaveUsoEspeciales.js"></script>
...
<div class="span12" >
		...
		<div class="control-group span3" >
			<div class="controls">
				...
				<label class="control-label" for="txt_FechaIni" style="display: flex; align-items: flex-end;">Fecha Inicial:				
		...
		<div class="span3">
			<div class="control-group">
				<div class="controls">
					<div class="row-fluid input-append">
					<label class="control-label" for="txt_FechaFin" style="display: flex; align-items: flex-end;">Fecha Final:&nbsp;
		...
		<div class="span3">
			<div class="control-group">
				<div class="controls">
					<label class="control-label" for="txt_clave" style="display: flex; align-items: center;">Clave de uso:&nbsp;
					<input id="txt_clave" type="text" class="input-small" maxlength="5"> 
					</label>
				</div>
			</div>
		</div>
		<div class="span3">
			<div class="control-group">
				<div class="controls">
					...
					<label class="lbl" for="chkbx_indefinido" style="display: flex; align-items: center;"> Indefinido &nbsp;</label>		
				</div>	
			</div>
		</div>		
</div>
