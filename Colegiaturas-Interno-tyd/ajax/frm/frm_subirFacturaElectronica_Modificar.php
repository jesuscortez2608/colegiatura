<?php
	...
	$NomXML = (isset($_POST['NomXML']) ? $_POSTS['NomXML'] : '');
	$NomPDF = (isset($_POST['NomPDF']) ? $_POSTS['NomPDF'] : '');
?>
<script type="text/javascript" src="files/js/utils.js"></script>
<script type="text/javascript" src="files/js/frm_subirFacturaElectronica_Modificar.js"></script>
...
<div class="page-content">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid" style="margin-bottom:10px; background-color:#307ECC; color:#FFFFFF;">
			<h4>Datos del Colaborador</h4>
		</div>
		
		<label id="lbl_estatus" style="display:none">Estatus</label>
		...
		<div class="control-group">
			<div class="row-fluid">
				<div class="span4">
					...
					<div class="controls">
						<input class="span10"  style="text-align:right;" id="txt_SueldoMensual" type="text" readonly />
					</div><br>
				...
				<div class="row-fluid">
					<div class="span9">
						...
						<div class="controls" id="div_xml">
							...
							<input type="hidden" id="txt_NomXML" name="txt_NomXML" value='<?php echo $NomXML;?>' />
							<input type="hidden" id="txt_NomPDF" name="txt_NomPDF" value='<?php echo $NomPDF;?>' />
	...
	<div id="modalBodyAgregarDetalle" class="modal-body" style="height:500px;">
		<div class="row" style="width:90%;">
			...
			<div class="span12" style="margin-bottom:4px;">
				...
				<div class="span4">
					<select id="cbo_Beneficiario" style="width:100%;" tabindex="1"></select>
				</div>
				<div class="span2" style="text-align:right;">
			...
			<div class="span12" style="margin-bottom:4px;">
				...
				<div class="span4">
					<select id="cbo_TipoPago" style="width:100%;" tabindex="2"></select>
				</div>
				...
				<div class="span4">
					<div class="contenido">
						<select id="cbo_Periodo" data-placeholder="SELECCIONE" style="width:100%;" multiple tabindex="3"></select>
					</div>
				</div>
			</div>
			...
			<div class="span12" style="margin-bottom:4px;">
				...
				<div class="span4">
					<select id="cbo_Escolaridad" style="width:100%;" tabindex="4"></select>
				</div>
				...
				<div class="span4">
					<select id="cbo_Grado" style="width:100%;" tabindex="5">
			...
			<div class="span12" style="margin-bottom:4px;">
				...
				<div class="span4">
					<select id="cbo_CicloEscolar" style="width:100%;" tabindex="6"></select>
				</div>
				...
				<div class="span4">
					<input class="currency" style="text-align:right" id="txt_importeConcep" style="width:100%;" tabindex="7" maxlength="8"/>					
			...
			<div class="span12" style="margin-bottom:4px;">
				...
				<div class="span4">
					<select id="cbo_Carrera" style="width:100%;" tabindex="6"></select>
				</div>
			...
			<div class="span12" style="margin-top:35px;">
				...
				<div class="span3">
					<button class="btn btn-small btn-primary" id="btn_AgregarB">
...
<div class="modal hide" tabindex="-1" style="width: 450px; height: 300px;position:fixed;" aria-hidden="false" id="dlg_AgregarAclaracion">
	<div class="modal-header widget-header">
...
<div id="dlg_AyudaEscuelas"  class="modal hide" tabindex="-1" style="width:600px; height:550px; position:fixed" >
	<div class="modal-header widget-header">
		<button type="button" class="close" data-dismiss="modal">×</button>			
