...
$(function(){
	...
	function ActualizarGrid(inicializar){
		...
		var sUrl = 'ajax/json/json_fun_reporte_escuelas_concluyo_revision.php?&session_name='+Session;
	...
	function fnEstructuraGrid(){
		jQuery("#gridEscuelas-table").jqGrid({
			// url:'',
			datatype:'json',
			colNames:LengStr.idMSG107,
			colModel:[
				{name: 'iestado',		index:'iestado',	width:10,	align:"right",	fixed: true,	hidden:true},
				{name: 'sestado',		index:'sestado',	width:290,	align:"left",	fixed: true,	hidden:false},
				{name: 'imunicipio',	index:'imunicipio',	width:10,	align:"right",	fixed: true,	hidden:true},
				{name: 'smunicipio',	index:'smunicipio',	width:290,	align:"left",	fixed: true,	hidden:false},
				{name: 'icantidad',		index:'icantidad',	width:280,	align:"center",	fixed: true,	hidden:false},
			],
	...
	function GenerarPDF(){
		NomEstado = $("#cbo_Estado option:selected").text();
		NomMunicipio = $("#cbo_Municipio option:selected").text();
		var sUrl = 'ajax/json/impresion_json_fun_reporte_escuelas_concluyo_revision.php?&session_name='+Session;
			sUrl += '&idEstado='+idEstado;
			sUrl += '&idMunicipio='+idMunicipio;
			sUrl += '&dFechaInicial='+dFechaInicial;
			sUrl += '&dFechaFinal='+dFechaFinal;
