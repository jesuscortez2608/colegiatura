...
SessionIs();	
	...
	function ActualizarGrid(inicializar){
		...
		var sUrl = 'ajax/json/json_fun_reporte_costos_modificados.php?&session_name='+Session;
...
//----------------------IMPRESION DE PDF------------------------------------------------	
	function GenerarPDF(){
		var sUrl = 'ajax/json/impresion_json_fun_reporte_costos_modificados.php?&session_name='+Session;
			sUrl += '&idusuario='+idUsuario;
			sUrl += '&idestado='+idEstado;
			sUrl += '&idmunicipio='+idMunicipio;
			sUrl += '&sidrfc='+sidRfc;
