...
GRANT ALL ON TABLE sapfamiliarhojas TO syspersonal; 
GRANT ALL ON TABLE sapfamiliarhojas TO sysinternet;
GRANT ALL ON TABLE sapfamiliarhojas TO sysetl;
GRANT ALL ON TABLE sapfamiliarhojas TO postgres;
